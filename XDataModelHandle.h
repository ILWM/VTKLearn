...
public:
    ...
    std::shared_ptr<XDataModel>& getActiveXDataModel(){
    ...
    std::vector<std::shared_ptr<XDataModel>>& getDataModelList(){
...
public:
    ...
    std::vector<std::shared_ptr<XDataModel>> mXDataModelList;
